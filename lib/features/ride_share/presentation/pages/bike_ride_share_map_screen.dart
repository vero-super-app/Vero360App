...
class BikeRideShareMapScreen extends ConsumerStatefulWidget {
  const BikeRideShareMapScreen({super.key});

  @override
  ConsumerState<BikeRideShareMapScreen> createState() =>
      _BikeRideShareMapScreenState();
}

class _BikeRideShareMapScreenState extends ConsumerState<BikeRideShareMapScreen>
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'You need to be signed in to book a bike ride',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: Colors.grey[600],
                ),
          ),
  ...
  Widget _buildActionButton(Place? selectedDropoffPlace) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          isReady ? 'Continue to Bike Booking' : 'Search Destination',
